namespace ToysShop.ProductForms
{
	partial class ProductForm
	{
		...
		private void InitializeComponent()
		{
			...
			// menuStrip1
			// 
			menuStrip1.Items.AddRange(new ToolStripItem[] { добавитьToolStripMenuItem, удалитьToolStripMenuItem, добавитьГруппуToolStripMenuItem });
			...
			добавитьГруппуToolStripMenuItem.Size = new Size(112, 20);
			добавитьГруппуToolStripMenuItem.Text = "Добавить группу";
			добавитьГруппуToolStripMenuItem.Click += добавитьГруппуToolStripMenuItem_Click;
			// 
			// ProductForm
			// 
			AutoScaleDimensions = new SizeF(7F, 15F);
			AutoScaleMode = AutoScaleMode.Font;
			ClientSize = new Size(375, 192);
		...
		private ToolStripMenuItem добавитьГруппуToolStripMenuItem;
	}
}